...
<template>
        ...
        <div class="flex items-center justify-between p-5 bg-secondary">
            <div>
                <div class="flex items-center">
                    <h2 class="text-xl py-5 px-3">Slider</h2>
                </div>
            </div>
    ...
    <Modal title="Create New Slider" :isOpen="isModalOpened" @modal-close="closeModal">
            ...
            <div class="w-full mb-4">
                <div>
                    ...
                    <label for="cover_image" class="w-full h-36 flex items-center
                        ...
                        <div v-else>
                            <p class="text-xs">Upload Slider Image</p>
                        </div>
                    </label>
                 </div>
            </div>
            <div class="w-full">
                <button @click="onSubmit" class="w-full bg-primary py-2.5">Save Slider</button>
            </div>
        </div>
    </Modal>
</template>
